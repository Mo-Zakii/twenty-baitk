...
import { AddFieldMetadataComputationColumnFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-19/2-19-instance-command-fast-1783204317531-add-field-metadata-computation-column';
...
export const INSTANCE_COMMANDS = [
  ...
  AddFieldMetadataComputationColumnFastInstanceCommand,
];
